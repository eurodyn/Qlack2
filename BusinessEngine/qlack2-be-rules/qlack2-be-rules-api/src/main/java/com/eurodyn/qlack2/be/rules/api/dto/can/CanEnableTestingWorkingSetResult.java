...
public class CanEnableTestingWorkingSetResult {
	private boolean result;

	// Cannot enbale testing, must also contain the reported data model versions
	private boolean incomplete;

	// Can enbale testing and will cascade to the reported versions
