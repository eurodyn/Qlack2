...
public class IsPermittedRequest extends QSignedRequest {
	private String operationName;
	private String resourceObjectId;

	public IsPermittedRequest(SignedTicket signedTicket, String operationName) {
		this.setSignedTicket(signedTicket);
		this.operationName = operationName;
	}

	public IsPermittedRequest(SignedTicket signedTicket, String operationName, String resourceObjectId) {
		this.setSignedTicket(signedTicket);
		this.operationName = operationName;
