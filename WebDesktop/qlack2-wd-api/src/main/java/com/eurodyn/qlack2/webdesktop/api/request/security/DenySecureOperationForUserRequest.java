...
public class DenySecureOperationForUserRequest extends QSignedRequest {
	private String userId;
	private String operationName;
	private String resourceObjectId;

	public DenySecureOperationForUserRequest() {
	}

	public DenySecureOperationForUserRequest(String userId,
			String operationName) {
		this.userId = userId;
		this.operationName = operationName;
	}

	public DenySecureOperationForUserRequest(String groupId,
