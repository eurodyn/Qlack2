...
public class AllowSecureOperationForGroupRequest extends QSignedRequest {
	private String groupId;
	private String operationName;
	private String resourceObjectId;

	public AllowSecureOperationForGroupRequest() {
	}

	public AllowSecureOperationForGroupRequest(String groupId,
