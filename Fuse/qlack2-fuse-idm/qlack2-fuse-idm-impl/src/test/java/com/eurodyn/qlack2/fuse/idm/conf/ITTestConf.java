package com.eurodyn.qlack2.fuse.idm.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-idm-deps"),
      ...
      url("file:../../../../qlack2-fuse-idm-api/target/qlack2-fuse-idm-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-idm-api") + ".jar"),
      url("file:../../qlack2-fuse-idm-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-idm-impl") + ".jar"),
    };
  }
}