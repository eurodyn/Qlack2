...
public class InternalMessageServiceImplTest extends ITTestConf {
    ...
    public void getInternalInboxFolder(){
        ...
        Assert.assertNotNull(internalMessageService.getInternalInboxFolder(internalMessagesID.getSrcUserId()));
    }
    ...
    public void getInternalSentFolder(){
        ...
        Assert.assertNotNull(internalMessageService.getInternalSentFolder(internalMessagesID.getSrcUserId()));
    }
    ...
    public void markMessageAsRead(){
        ...
        Assert.assertEquals(MaiConstants.MARK_READ,internalMessageService.getInternalMessage(internalMessagesID.getId()).getStatus());
    }
    ...
    public void markMessageAsReplied(){
        ...
        Assert.assertEquals(MaiConstants.MARK_REPLIED,internalMessageService.getInternalMessage(internalMessagesID.getId()).getStatus());
    }
    ...
    public void markMessageAsUnread(){
        ...
        Assert.assertEquals(MaiConstants.MARK_UNREAD,internalMessageService.getInternalMessage(internalMessagesID.getId()).getStatus());
    }
    ...
    public void deleteMessage(){
        ...
        Assert.assertEquals("S",internalMessageService.getInternalMessage(internalMessagesID.getId()).getDeleteType());
    ...
    public void getInternalMessageAttachments(){
        ...
        Assert.assertNotNull(internalMessageService.getInternalMessageAttachments(internalMessagesID.getId()));
    }
    ...
    public void getMailCount(){
        ...
        Assert.assertNotNull(internalMessageService.getMailCount(internalMessagesID.getSrcUserId(),internalMessagesID.getStatus()));
        Assert.assertTrue(internalMessageService.getMailCount(internalMessagesID.getSrcUserId(),internalMessagesID.getStatus()) != 0 );
    }
