 ...
 *
 * Following use case are implemented by the service: <ul> <li>Send internal message.</li> <li>Get
 * internal INBOX folder messages.</li> <li>Get internal SENT folder messages.</li> </ul>
 *
