package com.eurodyn.qlack2.fuse.clipboard.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-clipboard-deps"),
      ...
      url("file:../../../../qlack2-fuse-clipboard-api/target/qlack2-fuse-clipboard-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-clipboard-api") + ".jar"),
      url("file:../../qlack2-fuse-clipboard-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-clipboard-impl") + ".jar"),
    };
  }
}