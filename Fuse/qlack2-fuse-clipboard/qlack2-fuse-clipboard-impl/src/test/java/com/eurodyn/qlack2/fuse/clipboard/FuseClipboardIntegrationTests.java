package com.eurodyn.qlack2.fuse.clipboard;

import com.eurodyn.qlack2.fuse.clipboard.conf.ITTestConf;
import com.eurodyn.qlack2.fuse.clipboard.tests.ClipboardServiceImplTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        ClipboardServiceImplTest.class
})
public class FuseClipboardIntegrationTests {

  /**
   * JUL reference
   */
  private final static Logger LOGGER = Logger.getLogger(FuseClipboardIntegrationTests.class.getName());
