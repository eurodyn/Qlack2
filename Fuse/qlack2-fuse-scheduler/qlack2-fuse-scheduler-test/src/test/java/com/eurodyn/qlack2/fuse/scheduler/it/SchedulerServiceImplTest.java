...
public class SchedulerServiceImplTest extends ITTestConf {
    ...
    public void scheduleJob(){
        ...
        Assert.assertNotNull(schedulerService.getJobDetails(schedulerWrappedJob.getJobName(),schedulerWrappedJob.getJobGroup(),false));
    }
    ...
    public void start(){
        ...
        Assert.assertTrue(schedulerService.isStarted());
    }
    ...
    public void rescheduleJob(){
        ...
        SchedulerWrappedTrigger schedulerNewWrappedTrigger = TestUtilities.createSchedulerWrappedTrigger();
        schedulerService.rescheduleJob(schedulerWrappedJob.getJobName(),schedulerWrappedJob.getJobGroup(),schedulerNewWrappedTrigger);
        Assert.assertNotNull(schedulerService.getJobDetails(schedulerWrappedJob.getJobName(),schedulerWrappedJob.getJobGroup(),false));
    }
    ...
    public void deleteJob(){
        ...
        Assert.assertNull(schedulerService.getJobDetails(schedulerWrappedJob.getJobName(),schedulerWrappedJob.getJobGroup(),false));
    }
    ...
    public void triggerJob(){
        ...
        schedulerService.scheduleJob(schedulerWrappedJob,schedulerWrappedTrigger);
        schedulerService.triggerJob(schedulerWrappedJob.getJobName(),schedulerWrappedJob.getJobGroup());

        Assert.assertNotNull(schedulerService.getDateInfoForTrigger(schedulerWrappedTrigger.getTriggerName(),schedulerWrappedTrigger.getTriggerGroup()));
        Assert.assertEquals(date,schedulerService.getDateInfoForTrigger(schedulerWrappedTrigger.getTriggerName(),schedulerWrappedTrigger.getTriggerGroup()).getEndTime());
    }
    ...
    public void pauseTrigger(){
        ...
        schedulerService.scheduleJob(schedulerWrappedJob,schedulerWrappedTrigger);
        schedulerService.triggerJob(schedulerWrappedJob.getJobName(),schedulerWrappedJob.getJobGroup());
        schedulerService.pauseTrigger(schedulerWrappedTrigger.getTriggerName(),schedulerWrappedTrigger.getTriggerGroup());
    ...
    public void checkExistJob(){
        ...
        Assert.assertNotNull(schedulerService.checkExistJob(schedulerWrappedJob.getJobName(),schedulerWrappedJob.getJobGroup()));
    }
    ...
    public void checkExistTrigger(){
        ...
        Assert.assertNotNull(schedulerService.checkExistTrigger(schedulerWrappedTrigger.getTriggerName(),schedulerWrappedTrigger.getTriggerGroup()));
    }
