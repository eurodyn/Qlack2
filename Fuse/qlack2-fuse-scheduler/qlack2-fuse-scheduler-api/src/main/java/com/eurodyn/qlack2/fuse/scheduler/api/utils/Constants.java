...
public class Constants {
  ...
  // The name of the OSGi service representing the job that will be looked up by the scheduler
  // when the trigger of this job fires.
  ...
  public enum TRIGGERS {
    ASAP, Daily, Weekly, Monthly, Cron, Interval, DELAYED
  }
