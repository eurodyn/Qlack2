package com.eurodyn.qlack2.fuse.tickerserver;

import com.eurodyn.qlack2.fuse.tickerserver.conf.ITTestConf;
import com.eurodyn.qlack2.fuse.tickerserver.tests.TicketServerImplTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
  TicketServerImplTest.class,
})
public class FuseTicketServerIntegrationTests {
