package com.eurodyn.qlack2.fuse.tickerserver.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-ticket-server-deps"),
      ...
      url("file:../../../../qlack2-fuse-ticket-server-api/target/qlack2-fuse-ticket-server-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-ticket-server-api") + ".jar"),
      url("file:../../qlack2-fuse-ticket-server-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-ticket-server-impl") + ".jar"),
    };
  }
}