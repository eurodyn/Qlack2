...
public class ServiceImplTest extends ITTestConf {
  ...
  public void testUpdateMapping() {
    ...
    createIndexRequest.setName(indexName);
    createIndexRequest
        .setIndexMapping("{\"type1\": {\"properties\": {\"field1\": {\"type\": \"text\"}}}}");
  ...
  public void testCloseIndex() {
    ...
    boolean result = adminService.closeIndex(indexName);
  ...
  public void testOpenIndex() {
    ...
    boolean resultCloseIndex = adminService.closeIndex(indexName);

    Assert.assertTrue(resultCloseIndex);
