package com.eurodyn.qlack2.fuse.ts;
...
import com.eurodyn.qlack2.fuse.ts.tests.TemplateServiceImplTest;
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({TemplateServiceImplTest.class})
public class FuseTemplateServiceIntegrationTests {

  // JUL reference.
  private final static Logger LOGGER =
      Logger.getLogger(FuseTemplateServiceIntegrationTests.class.getName());
  ...
  public static void beforeClass()
    ...
    if (!dbAvailabilityCheck.isAvailable(ITTestConf.testingEnv.getDbUrl(),
        ITTestConf.testingEnv.getDbUser(), ITTestConf.testingEnv.getDbPassword(),
