package com.eurodyn.qlack2.fuse.ts.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    // KarafDistributionOption.debugConfiguration("5005", true),
      ...
      features(projectFeaturesRepo, "qlack2-fuse-template-service-deps"),
      ...
      url("file:../../../../qlack2-fuse-template-service-api/target/qlack2-fuse-template-service-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-template-service-api") + ".jar"),
      url("file:../../qlack2-fuse-template-service-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-template-service-impl") + ".jar"),
    };
  }
}