package com.eurodyn.qlack2.fuse.rules.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-rules-runtime-deps"),
      ...
      url("file:../../../../qlack2-fuse-rules-runtime-api/target/qlack2-fuse-rules-runtime-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-rules-runtime-api") + ".jar"),
      url("file:../../qlack2-fuse-rules-runtime-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-rules-runtime-impl") + ".jar"),
    };
  }
}