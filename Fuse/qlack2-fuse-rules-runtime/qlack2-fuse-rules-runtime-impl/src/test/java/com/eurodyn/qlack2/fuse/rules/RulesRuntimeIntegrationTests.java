package com.eurodyn.qlack2.fuse.rules;

import com.eurodyn.qlack2.fuse.rules.conf.ITTestConf;
import com.eurodyn.qlack2.fuse.rules.tests.RulesRuntimeServiceImplTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
    RulesRuntimeServiceImplTest.class
})
public class RulesRuntimeIntegrationTests {

  /**
   * JUL reference
   */
  private final static Logger LOGGER = Logger.getLogger(RulesRuntimeIntegrationTests.class.getName());
