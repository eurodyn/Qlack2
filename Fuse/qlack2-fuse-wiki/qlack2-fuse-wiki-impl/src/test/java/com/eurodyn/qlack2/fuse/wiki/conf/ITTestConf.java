package com.eurodyn.qlack2.fuse.wiki.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-wiki-deps"),
      ...
      url("file:../../../../qlack2-fuse-wiki-api/target/qlack2-fuse-wiki-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-wiki-api") + ".jar"),
      url("file:../../qlack2-fuse-wiki-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-wiki-impl") + ".jar"),
    };
  }
}