...
import com.eurodyn.qlack2.fuse.wiki.TestUtil;
...
import java.io.File;
import static com.eurodyn.qlack2.fuse.wiki.TestUtil.copyITConf;
    ...
    public static Option[] config() {
        ...
        return new Option[]{
               ...
               "org.ops4j.pax.url.mvn.localRepository", localRepository)),
                ...
                features(projectFeaturesRepo,"qlack2-fuse-wiki"),
        };
