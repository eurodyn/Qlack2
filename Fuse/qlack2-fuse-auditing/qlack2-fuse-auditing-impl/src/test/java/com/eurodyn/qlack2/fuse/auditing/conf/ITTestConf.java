package com.eurodyn.qlack2.fuse.auditing.conf;
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      url("file:../../../../qlack2-fuse-auditing-api/target/qlack2-fuse-auditing-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-auditing-api") + ".jar"),
      url("file:../../qlack2-fuse-auditing-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-auditing-impl") + ".jar"),
    };
  }
