...
public class AuditLevelServiceImplTest extends ITTestConf {
    ...
    public void updateLevel(){
        ...
        Assert.assertEquals("testDescr13",auditLevelService.getAuditLevelByName("testName13").getDescription());
    }
    ...
    public void getAuditLevelByName(){
        ...
        Assert.assertEquals("testName14",auditLevelService.getAuditLevelByName("testName14").getName());
    }
