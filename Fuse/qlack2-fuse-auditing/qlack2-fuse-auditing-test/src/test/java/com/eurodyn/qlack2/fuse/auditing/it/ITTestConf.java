...
import com.eurodyn.qlack2.fuse.auditing.TestUtil;
import org.ops4j.pax.exam.Configuration;
import org.ops4j.pax.exam.Option;
import org.ops4j.pax.exam.karaf.options.LogLevelOption;
import org.ops4j.pax.exam.options.MavenArtifactUrlReference;
import org.ops4j.pax.exam.options.MavenUrlReference;
import static com.eurodyn.qlack2.fuse.auditing.TestUtil.copyITConf;
...
public abstract class ITTestConf {
    ...
    public static Option[] config() {
        ...
        return new Option[]{
                ...
                features(projectFeaturesRepo, "qlack2-fuse-auditing"),
                features(projectFeaturesRepo, "qlack2-fuse-auditing-client")
        };
    }
