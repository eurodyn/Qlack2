package com.eurodyn.qlack2.fuse.lexicon.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-lexicon-deps"),
      ...
      url("file:../../../../qlack2-fuse-lexicon-api/target/qlack2-fuse-lexicon-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-lexicon-api") + ".jar"),
      url("file:../../qlack2-fuse-lexicon-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-lexicon-impl") + ".jar"),
    };
  }
}