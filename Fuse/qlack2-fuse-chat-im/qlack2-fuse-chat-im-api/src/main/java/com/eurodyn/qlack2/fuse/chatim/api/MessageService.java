...
public interface MessageService {
	...
	/**
	 * Posts a message to a chat room. If filters are available for this chat
	 * room the message is appropriately filtered and the filtered text is
	 * actually committed to the system.
	 *
	 * @param messageDTO
	 *            The message to post
	 * @return
