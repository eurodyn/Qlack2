package com.eurodyn.qlack2.fuse.chatim.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-chat-im-deps"),
      ...
      url("file:../../../../qlack2-fuse-chat-im-api/target/qlack2-fuse-chat-im-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-chat-im-api")
        + ".jar"),
      url("file:../../qlack2-fuse-chat-im-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-chat-im-impl")
        + ".jar"),
    };
  }
}