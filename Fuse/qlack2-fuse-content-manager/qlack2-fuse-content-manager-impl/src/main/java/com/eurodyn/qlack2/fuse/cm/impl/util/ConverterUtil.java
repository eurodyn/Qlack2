...
public class ConverterUtil {
   ...
   *        specific entity.
   * @param findPath Specifies whether the file structure path until the provided entity should be
   *        computed (when true).
   * @return FolderDTO
   */
  public static FolderDTO nodeToFolderDTO(Node entity, boolean lazyRelatives, boolean findPath) {
   ...
   * @return FileDTO
   */
  public static FileDTO nodeToFileDTO(Node entity, boolean lazyRelatives, boolean findPath) {
    if (entity == null) {
      return null;
    }
  ...
  /**
   * Node to node DTO list.
   *
   * @param entities the entities
   * @return the list
   */
  public static List<NodeDTO> nodeToNodeDTOList(List<Node> entities) {
    if (entities == null) {
      return null;
    }
   ...
   * @return the list
   */
  private static List<BreadcrumbPartDTO> findDirectoryPath(Node entity,
      List<BreadcrumbPartDTO> path) {
  ...
  public static Node nodeDTOToNode(NodeDTO dto) {
    ...
    entity.getAttributes()
        .add(new NodeAttribute(Constants.LOCKABLE, String.valueOf(dto.isLockable()), entity));
    entity.getAttributes()
        .add(new NodeAttribute(Constants.VERSIONABLE, String.valueOf(dto.isVersionable()), entity));

    if (dto.getAttributes() != null) {
      for (String attrName : dto.getAttributes().keySet()) {
        entity.getAttributes()
            .add(new NodeAttribute(attrName, dto.getAttributes().get(attrName), entity));
      }
    }
    return entity;
  }
