...
public class DBStorage implements StorageEngine {
  ...
  public byte[] getVersionContent(String versionID) throws IOException {
    ...
    TypedQuery<VersionBin> q =
        em.createQuery("from VersionBin vb where vb.version = :version " + "order by vb.chunkIndex",
            VersionBin.class);
  ...
  public BinChunkDTO getBinChunk(String versionID, int chunkIndex) {
    ...
    TypedQuery<VersionBin> q = em.createQuery("from VersionBin vb where vb.version = :version and "
        + "vb.chunkIndex in :chunkIndexes order by vb.chunkIndex", VersionBin.class);
    q.setParameter("version", version);
