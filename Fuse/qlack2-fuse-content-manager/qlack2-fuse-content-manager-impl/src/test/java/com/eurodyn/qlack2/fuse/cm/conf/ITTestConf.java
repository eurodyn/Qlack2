package com.eurodyn.qlack2.fuse.cm.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-content-manager-deps"),
      ...
      url("file:../../../../qlack2-fuse-content-manager-api/target/qlack2-fuse-content-manager-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-content-manager-api") + ".jar"),
      url("file:../../qlack2-fuse-content-manager-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-content-manager-impl") + ".jar"),
    };
  }
}