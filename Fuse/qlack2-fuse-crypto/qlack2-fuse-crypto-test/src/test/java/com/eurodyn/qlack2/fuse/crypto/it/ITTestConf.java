...
import com.eurodyn.qlack2.fuse.crypto.TestUtil;
...
public abstract class ITTestConf {
  ...
  private static Option addCodeCoverageOption() {
    ...
    if (coverageCommand != null) {
      LOGGER.log(Level.CONFIG, "Setting coverage command to: " + coverageCommand);
  ...
  public static Option[] config() {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-crypto"),
    };
