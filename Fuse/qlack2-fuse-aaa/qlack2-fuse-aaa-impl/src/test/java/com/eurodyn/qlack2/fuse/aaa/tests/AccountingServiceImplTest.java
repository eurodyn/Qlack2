...
public class AccountingServiceImplTest extends ITTestConf {
   ...
   * JUL reference
   */
  private final static Logger LOGGER = Logger.getLogger(AccountingServiceImplTest.class.getName());
  ...
  public void getSessionIDsForAttribute() {
    ...
    Assert.assertNotNull(accountingService
      .getSessionIDsForAttribute(sessAttrs, sessionAttributeDTO.getName(),
