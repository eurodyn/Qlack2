...
public class UserGroupServiceImplTest extends ITTestConf {
  ...
  public void moveGroup() {
    ...
    groupMvGroupDTO.setDescription(TestConst.GROUP_DESCRIPTION);
  ...
  public void getGroupByNames() {
    ...
    Assert.assertEquals(5, userGroupService.getGroupByNames(testGroupNames, false).size());
  }
  ...
  public void getGroupParent() {
    ...
    GroupDTO groupGetParentDTO = TestUtilities.createGroupDTO();
  ...
  public void addUsersByGroupName() {
    //creates User
    UserDTO usersDTO = TestUtilities.createUserDTO();
