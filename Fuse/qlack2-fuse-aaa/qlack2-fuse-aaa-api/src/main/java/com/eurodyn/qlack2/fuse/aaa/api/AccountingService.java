...
public interface AccountingService {
  ...
  /**
   * Terminates a session by the application session Id.
   * @param applicationSessionId The application session Id to find the underlying session from.
   */
  ...
  /**
   * Checks if a given attribute name, with a given value, is unique.
   * @param userId The user Id to check the sessions of.
   * @param attributeName The name of the attribute to check.
   * @param attributeValue The value of the attribute to check.
   * @return Returns true if the attribute with the given name and values has never been recorded
