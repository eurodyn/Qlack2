...
public class TestUtilities {
    ...
    public static OperationDTO createOperationDTO(){
        ...
        operationDTO.setName(com.eurodyn.qlack2.fuse.aaa.util.TestConst.generateRandomString());
        operationDTO.setDescription(com.eurodyn.qlack2.fuse.aaa.util.TestConst.OPERATION_DESCRIPTION);
        operationDTO.setDynamic(com.eurodyn.qlack2.fuse.aaa.util.TestConst.OPERATION_DYNAMIC);
        operationDTO.setDynamicCode(com.eurodyn.qlack2.fuse.aaa.util.TestConst.OPERATION_DYNAMIC_CODE);
    ...
    public static ResourceDTO createResourceDTO() {
        ...
        resourceDTO.setDescription(com.eurodyn.qlack2.fuse.aaa.util.TestConst.RESOURCE_DESCRIPTION);
        resourceDTO.setName(com.eurodyn.qlack2.fuse.aaa.util.TestConst.generateRandomString());
    ...
    public static UserDTO createUserDTO(){
        ...
        attributeDTO.setName(com.eurodyn.qlack2.fuse.aaa.util.TestConst.generateRandomString());
    ...
    public static UserAttributeDTO createuserAttributeDTO() {
        ...
        userAttributeDTO.setName(com.eurodyn.qlack2.fuse.aaa.util.TestConst.generateRandomString());
        userAttributeDTO.setData(com.eurodyn.qlack2.fuse.aaa.util.TestConst.USERATTRIBUTE_DATA);
    ...
    public static OpTemplateDTO createOpTemplateDTO(){
        ...
        opTemplate.setDescription(com.eurodyn.qlack2.fuse.aaa.util.TestConst.OPTEMPLATE_DESCRIPTION);
        opTemplate.setName(com.eurodyn.qlack2.fuse.aaa.util.TestConst.generateRandomString());
    ...
    public static SessionAttributeDTO createSessionAttributeDTO(){
        ...
        sessionAttributeDTO.setName(com.eurodyn.qlack2.fuse.aaa.util.TestConst.generateRandomString());
        sessionAttributeDTO.setId(UUID.randomUUID().toString());
