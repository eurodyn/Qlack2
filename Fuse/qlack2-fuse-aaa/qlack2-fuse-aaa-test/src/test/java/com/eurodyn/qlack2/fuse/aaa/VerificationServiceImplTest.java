...
public class VerificationServiceImplTest extends ITTestConf {
    ...
    public void createVerificationToken(){
        Assert.assertNotNull(verificationService.createVerificationToken(
          com.eurodyn.qlack2.fuse.aaa.util.TestConst.VERIFICATION_EXPIRES_ON,
          com.eurodyn.qlack2.fuse.aaa.util.TestConst.VERIFICATION_DATA));
    }
    ...
    public void verifyToken(){
        String tokenID= verificationService.createVerificationToken(
          com.eurodyn.qlack2.fuse.aaa.util.TestConst.VERIFICATION_EXPIRES_ON);
    ...
    public void getTokenPayload(){
        String tokenID = verificationService.createVerificationToken(
          com.eurodyn.qlack2.fuse.aaa.util.TestConst.VERIFICATION_EXPIRES_ON, TestConst.VERIFICATION_DATA);
        Assert.assertNotNull(tokenID);
