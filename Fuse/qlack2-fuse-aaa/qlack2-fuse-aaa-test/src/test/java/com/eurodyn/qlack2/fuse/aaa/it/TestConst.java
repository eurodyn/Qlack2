...
public class TestConst {
    ...
    public static final String USER_PASSWORD = generateRandomString();
    public static final boolean USER_SUPERADMIN = false;
    public static final boolean USER_EXTERNAL = false;
    public static final String GROUP_DESCRIPTION = generateRandomString();
    public static final String USERATTRIBUTE_DATA = generateRandomString();
    public static final String SESSION_ATTRIBUTE_VALUE = generateRandomString();
    public static final String OPERATION_DESCRIPTION = generateRandomString();
    public static final boolean OPERATION_DYNAMIC = false;
    public static final String OPERATION_DYNAMIC_CODE = generateRandomString();
