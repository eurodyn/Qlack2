...
public class OperationServiceImplTest extends ITTestConf {
    ...
    public void createOperation(){
        OperationDTO operationDTO = com.eurodyn.qlack2.fuse.aaa.util.TestUtilities.createOperationDTO();
    ...
    public void updateOperation() throws Exception {
        ...
        operationDTO.setName("testName01");
        operationDTO.setDescription("testDescr01");
        ...
        OperationDTO operationUpdDTO = operationService.getOperationByName("testName01");
        Assert.assertNotNull(operationUpdDTO );

        operationUpdDTO.setName("testName02");
        operationUpdDTO.setDescription("testDescr02");

        //updates Operation with new values
        operationService.updateOperation(operationUpdDTO);
        OperationDTO operationUpdName = operationService.getOperationByName("testName02");
    ...
    public void addOperationToUserArgs() throws Exception {
        ...
        //creates Resource
        ResourceDTO resourceDTO = com.eurodyn.qlack2.fuse.aaa.util.TestUtilities.createResourceDTO();
    ...
    public void addOperationsToUserFromTemplateID() throws Exception {
        ...
        OpTemplateDTO opTemplateDTO = com.eurodyn.qlack2.fuse.aaa.util.TestUtilities.createOpTemplateDTO();
