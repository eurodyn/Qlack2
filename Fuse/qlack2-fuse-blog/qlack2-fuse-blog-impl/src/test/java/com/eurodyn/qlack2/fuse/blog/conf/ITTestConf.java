package com.eurodyn.qlack2.fuse.blog.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-blog-deps"),
      ...
      url("file:../../../../qlack2-fuse-blog-api/target/qlack2-fuse-blog-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-blog-api") + ".jar"),
      url("file:../../qlack2-fuse-blog-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-blog-impl") + ".jar"),
    };
  }
}