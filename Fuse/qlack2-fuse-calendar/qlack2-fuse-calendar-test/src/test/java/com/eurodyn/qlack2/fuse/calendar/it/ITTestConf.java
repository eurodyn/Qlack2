...
import com.eurodyn.qlack2.fuse.calendar.TestUtil;
...
import java.io.File;
import static com.eurodyn.qlack2.fuse.calendar.TestUtil.copyITConf;
...
public abstract class ITTestConf {
    ...
    public static Option[] config() {
        ...
        return new Option[]{
                ...
                features(projectFeaturesRepo, "qlack2-fuse-calendar")
        };
