package com.eurodyn.qlack2.fuse.calendar.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-calendar-deps"),
      CoreOptions.wrappedBundle(
        CoreOptions.mavenBundle("com.eurodyn.qlack2.util", "qlack2-util-testing")),
      CoreOptions.wrappedBundle(
        CoreOptions.mavenBundle("com.eurodyn.qlack2.util", "qlack2-util-networking")),
      url("file:../../../../qlack2-fuse-calendar-api/target/qlack2-fuse-calendar-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-calendar-api")
        + ".jar"),
      url("file:../../qlack2-fuse-calendar-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-calendar-impl")
        + ".jar"),
    };
  }
}