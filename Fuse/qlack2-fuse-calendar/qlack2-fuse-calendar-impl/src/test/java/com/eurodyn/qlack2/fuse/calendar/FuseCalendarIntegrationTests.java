package com.eurodyn.qlack2.fuse.calendar;

import com.eurodyn.qlack2.fuse.calendar.conf.ITTestConf;
import com.eurodyn.qlack2.fuse.calendar.tests.CalendarItemServiceImplTest;
import com.eurodyn.qlack2.fuse.calendar.tests.CalendarServiceImplTest;
import com.eurodyn.qlack2.fuse.calendar.tests.ImportExportServiceImplTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
  CalendarItemServiceImplTest.class,
  CalendarServiceImplTest.class,
  ImportExportServiceImplTest.class
})
public class FuseCalendarIntegrationTests {

  /**
   * JUL reference
   */
  private final static Logger LOGGER = Logger.getLogger(FuseCalendarIntegrationTests.class.getName());
