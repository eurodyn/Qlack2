package com.eurodyn.qlack2.fuse.componentlibrary.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-component-library-deps"),
      ...
      url("file:../../../../qlack2-fuse-component-library-api/target/qlack2-fuse-component-library-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-component-library-api") + ".jar"),
      url("file:../../qlack2-fuse-component-library-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-component-library-impl") + ".jar"),
    };
  }
}