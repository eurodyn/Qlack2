package com.eurodyn.qlack2.fuse.proxy.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      TestingUtil.copyITConf("etc/com.eurodyn.qlack2.fuse.security.proxy.cfg"),
      ...
      features(projectFeaturesRepo, "qlack2-fuse-security-proxy-deps"),
      CoreOptions.mavenBundle("org.mockito", "mockito-all").versionAsInProject(),
      ...
      url("file:../../../../qlack2-fuse-security-proxy-api/target/qlack2-fuse-security-proxy-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-security-proxy-api") + ".jar"),
      url("file:../../qlack2-fuse-security-proxy-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-security-proxy-impl") + ".jar"),
    };
  }
}