package com.eurodyn.qlack2.fuse.proxy;

import com.eurodyn.qlack2.fuse.proxy.conf.ITTestConf;
import com.eurodyn.qlack2.fuse.proxy.tests.SecurityProxyImplTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        SecurityProxyImplTest.class,
})
public class FuseSecurityProxyIntegrationTests {

  /**
   * JUL reference
   */
  private final static Logger LOGGER = Logger.getLogger(FuseSecurityProxyIntegrationTests.class.getName());
