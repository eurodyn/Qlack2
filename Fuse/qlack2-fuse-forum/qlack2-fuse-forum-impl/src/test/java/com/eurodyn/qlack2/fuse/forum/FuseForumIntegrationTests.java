package com.eurodyn.qlack2.fuse.forum;

import com.eurodyn.qlack2.fuse.forum.conf.ITTestConf;
import com.eurodyn.qlack2.fuse.forum.tests.ForumServiceImplTest;
import com.eurodyn.qlack2.fuse.forum.tests.MessageServiceImplTest;
import com.eurodyn.qlack2.fuse.forum.tests.TopicServiceImplTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        ForumServiceImplTest.class,
        MessageServiceImplTest.class,
        TopicServiceImplTest.class
})
public class FuseForumIntegrationTests {
