package com.eurodyn.qlack2.fuse.settings.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-settings-deps"),
      ...
      url("file:../../../../qlack2-fuse-settings-api/target/qlack2-fuse-settings-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-settings-api") + ".jar"),
      url("file:../../qlack2-fuse-settings-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-settings-impl") + ".jar"),
    };
  }
}