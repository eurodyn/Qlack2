package com.eurodyn.qlack2.fuse.settings;

import com.eurodyn.qlack2.fuse.settings.conf.ITTestConf;
import com.eurodyn.qlack2.fuse.settings.tests.SettingsServiceImplTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        SettingsServiceImplTest.class,
})
public class FuseSettingsIntegrationTests {

  /**
   * JUL reference
   */
  private final static Logger LOGGER = Logger.getLogger(FuseSettingsIntegrationTests.class.getName());
