...
import com.eurodyn.qlack2.fuse.settings.TestUtil;
...
import java.io.File;
import static com.eurodyn.qlack2.fuse.settings.TestUtil.copyITConf;
    ...
    public static Option[] config() {
        ...
        return new Option[]{
               ...
               "org.ops4j.pax.url.mvn.localRepository", localRepository)),
                ...
                features(projectFeaturesRepo,"qlack2-fuse-settings"),
				features(projectFeaturesRepo,"qlack2-fuse-idm"),
				features(projectFeaturesRepo,"qlack2-fuse-ticketservice"),
        };
