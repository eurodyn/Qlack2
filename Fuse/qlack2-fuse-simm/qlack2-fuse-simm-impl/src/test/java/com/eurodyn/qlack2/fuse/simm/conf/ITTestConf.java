package com.eurodyn.qlack2.fuse.simm.conf;
...
public abstract class ITTestConf {
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      features(projectFeaturesRepo, "qlack2-fuse-simm-deps"),
      ...
      url("file:../../../../qlack2-fuse-simm-api/target/qlack2-fuse-simm-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-simm-api") + ".jar"),
      url("file:../../qlack2-fuse-simm-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-simm-impl") + ".jar"),
    };
  }
}