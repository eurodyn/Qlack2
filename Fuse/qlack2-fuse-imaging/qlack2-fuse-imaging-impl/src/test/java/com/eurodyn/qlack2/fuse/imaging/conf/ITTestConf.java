package com.eurodyn.qlack2.fuse.imaging.conf;
  ...
  public static Option[] config() throws IOException {
    ...
    return new Option[]{
      ...
      url("file:../../../../qlack2-fuse-imaging-api/target/qlack2-fuse-imaging-api-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-imaging-api") + ".jar"),
      url("file:../../qlack2-fuse-imaging-impl-" +
        MavenUtils.getArtifactVersion("com.eurodyn.qlack2.fuse", "qlack2-fuse-imaging-impl") + ".jar"),
    };
  }
}